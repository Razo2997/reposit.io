    ...
    <div id="sidebar-nav" class="sidebar">
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    <li>
                        <a href="#posts" data-toggle="collapse" class="collapsed active mt-2"><i class="lnr lnr-file-empty"></i> <span>Posts</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
                    ...
                    <li>
                        <a href="#users" data-toggle="collapse" class="collapsed  mt-2"><i class="lnr lnr-file-empty"></i> <span>Users</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
                        <div id="users" class="collapse ">
                            <ul class="nav">
                                <li><a href="{{route('all_users')}}" >All Users</a></li>
                                <li><a href="#" >All Editors</a></li>
